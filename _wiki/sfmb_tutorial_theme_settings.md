...
1. Add / create a theme by clicking `Add`, then name it as you want.
	- <img width="368" height="591" alt="image" src="https://github.com/user-attachments/assets/aba31c4a-d55a-4987-9884-e2630a4ce996" />
...
1. Add a layer resource by clicking `Add`, then enter the name of the layer file without the word "Layer". e.g. `OverworldClouds`.
	- <img width="365" height="594" alt="image" src="https://github.com/user-attachments/assets/7b7d5861-59dc-4969-ab35-524c5af90bc1" />
